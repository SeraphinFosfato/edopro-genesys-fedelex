...
enum GUI {
	...
	BUTTON_TITLE_AUTH, // main menu: toggles Login/Logout (FASE 4f, §12)
	EDITBOX_TITLE_CREDENTIAL,
	BUTTON_TITLE_AUTH_SAVE,
	BUTTON_TITLE_AUTH_CANCEL,

	ACTION_UPDATE_PROMPT,
	ACTION_ACKNOWLEDGE_HOST,
	ACTION_SHOW_CHANGELOG,
	ACTION_BANLIST_UPDATE_PROMPT,
	BUTTON_SHOW_BANLIST_DIFF,
	BUTTON_BANLIST_DIFF_EXIT,
